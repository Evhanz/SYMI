...
@section('content-header')
    ...
    <div style="padding-left:5px;">
        <div class="bs-callout bs-callout-info" id="callout-type-dl-truncate">
            <h4>Módulo del Personal / Profesiones</h4>
        </div>
    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="ui icon buttons">
                                                    <button ng-click="edit({{$profesion->id}});" class="btn btn-warning">
      ...
      <div class="modal-dialog">
        ...
        <form class="ui form" action="{{ URL::route('editArea') }}" method="post">
          ...
          <div class="modal-body">
                ...
                <div class="form-group">
                    <label >ID</label>
                    <input ng-model="profesion.id" name="id" class="form-control" type="text" readonly>
                </div>
                <div class="form-group">
                    <label >Descripción</label>
                    <input ng-model="profesion.descripcion" class="form-control" type="text" name="descripcion" autocomplete="off" placeholder="Descripcion" required>
                </div>
                <div class="form-group">
                    <label >Observación</label>
                    <textarea ng-model="profesion.observacion" class="form-control" name="observacion" autocomplete="off" required></textarea>
                </div>          
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
